        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">Project-Management</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">Cloud-Computing</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">Development</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">Operations</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">DevOps</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">SEO Optimization</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">Coaching</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="0">
                <div class="icon-box">
                    ...
                    <h4><a href="<?= getProjectURL(); ?>/index.php#services">Pentesting & Cyber-Security and Auditing</a></h4>
